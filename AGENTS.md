...
The spawn must resolve a genuine isolated task worktree outside the primary checkout, not merely a different directory; a failed isolation assertion stops the task.
